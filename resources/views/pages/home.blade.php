...
@section('content')
   <div class="pxp-content">
      ...
      <div class="pxp-services-accordion pxp-services-accordion-has-image mt-100">
         ...
         <div class="row no-gutters align-items-center">
            <div class="col-md-6">
               ...
               <div class="pxp-services-accordion-fig pxp-cover" style="background-image: url(https://crm.rochman-properties.co.ke/public//media/gallery/Award.webp);"></div>
            </div>
      ...
      <div class="pxp-testim-1 pt-100 pb-100 mt-100 pxp-cover" style="background-image: url({!! asset('assets/images/testim-1-fig.webp') !!});">
