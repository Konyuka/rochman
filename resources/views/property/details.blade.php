...
@endsection
@section('url')
    {!! route('properties.details', $property->url) !!}
@endsection
@section('image')
    @if (CMS::check_cover_image($property->id) == 1)
        {!! CMS::admin() !!}media/products/{!! CMS::cover_image($property->id)->file_name !!}@else{!! asset('assets/images/placeholder.png') !!}
    @endif
@endsection
@section('article')
    ...
    <div class="pxp-content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="pxp-sp-top-btns mt-2 mt-md-0">
                            @if ($property->video)
                                <a href="{!! $property->video !!}" target="_blank" class="pxp-sp-top-btn"><span
                                        class="fa fa-play"></span> Video</a>
                            @endif
                            @php
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item"
                                        onClick="window.open('http://www.facebook.com/sharer.php?s=100&amp;p[title]={{ $title }}&amp;p[url]={{ $url }}&amp;&p[images][0]={{ $image }}', 'sharer', 'toolbar=0,status=0,width=548,height=325');"
                                        target="_parent" href="javascript: void(0)"><span class="fa fa-facebook"></span>
                                        Facebook</a>
                                    @php
                                    ...
                                    @endphp
                                    <a class="dropdown-item" href="{{ $link }}" target="_blank"><span
        ...
        <div class="pxp-single-property-gallery-container mt-4 mt-md-5">
            <div class="pxp-single-property-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                @if (CMS::check_cover_image($property->id) == 1)
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"
                        ...
                        <a data-fancybox="light-masonry"
                            href="{!! CMS::admin() !!}media/products/{!! CMS::cover_image($property->id)->file_name !!}" itemprop="contentUrl"
                            data-size="1920x1280" class="pxp-cover"
                            style="background-image: url({!! CMS::admin() !!}media/products/{!! CMS::cover_image($property->id)->file_name !!});"></a>
                        <figcaption itemprop="caption description">Image caption</figcaption>
                    </figure>
                @else
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"
                        class="pxp-sp-gallery-main-img">
                        <a data-fancybox="light-masonry" href="{!! asset('assets/images/placeholder.png') !!}" itemprop="contentUrl"
                            data-size="1920x1280" class="pxp-cover"
                            style="background-image: url({!! asset('assets/images/placeholder.png') !!});"></a>
                        <figcaption itemprop="caption description">Image caption</figcaption>
                    </figure>
                @endif
                ...
                @foreach ($images as $image)
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                        <a data-fancybox="light-masonry"
                            href="{!! CMS::admin() !!}media/products/{!! $image->file_name !!}" itemprop="contentUrl"
                            data-size="1920x1459" class="pxp-cover"
                            style="background-image: url({!! CMS::admin() !!}media/products/{!! $image->file_name !!});"></a>
                        {{-- <figcaption itemprop="caption description">Image caption</figcaption> --}}
                        <figcaption itemprop="caption description">Image caption</figcaption>
                    </figure>
                @endforeach
         ...
         --}}
            ...
            <a data-fancybox="light-masonry" href="{!! CMS::admin() !!}media/products/{!! CMS::cover_image($property->id)->file_name !!}"
                class="pxp-sp-gallery-btn">
                View Photos</a>
                    ...
                    <div class="pxp-single-property-section mt-4 mt-md-5">
                        ...
                        <div class="row mt-3 mt-md-4">
                            ...
                            @if (CMS::check_string($property->amenities, 'Air Conditioning') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-sun-o"></span> Air Conditioning
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Dishwasher') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-bullseye"></span> Dishwasher
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'Storage space') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Storage space
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Large closets') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Large closets
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Walk-in closets') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Walk-in closets
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'Energy-efficient appliances') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Energy-efficient
                                        appliances</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Renovated kitchen') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Renovated kitchen
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Marble or granite countertops') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Marble or granite
                                        countertops</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Garbage disposal') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Garbage disposal
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Built-in microwave') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Built-in
                                        microwave</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Large windows with lots of light') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Large windows
                                        with lots of light</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Window coverings') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Window coverings
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'Hardwood floors') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Hardwood floors
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Pet-friendly') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Pet-friendly
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'Level (garden versus penthouse)') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Level (garden
                                        versus penthouse)</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Wheelchair accessible') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Wheelchair
                                        accessible</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Pet washing stations') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Pet washing
                                        stations</div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'Pet grooming') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Pet grooming
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Laundry facilities') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Laundry
                                        facilities</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Laundry services') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Laundry services
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Dry-cleaning') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Dry-cleaning
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Swimming pool') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Swimming pool
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'Fitness center') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Fitness center
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'Sports court') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Sports court
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Tennis courts') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Tennis courts
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Pickle ball courts') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Pickle ball
                                        courts</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Grilling areas') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Grilling areas
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'Rooftop deck') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Rooftop deck
                                    </div>
                                </div>
                            @endif
                            ...
                            @if (CMS::check_string($property->amenities, 'On-site daycare') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> On-site daycare
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'On-site classes') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> On-site classes
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Gated community') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Gated community
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Controlled access') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Controlled access
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Security guard') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Security guard
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Secured garage') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Secured garage
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Parking space') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Parking space
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Firepits') == 'true')
                            ...
                            @if (CMS::check_string($property->amenities, 'Access to public transportation') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Access to public
                                        transportation</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Electric vehicle charging stations') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Electric vehicle
                                        charging stations</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Guest parking') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Guest parking
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Conference rooms') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Conference rooms
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Co-working spaces') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Co-working spaces
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Printing services') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Printing services
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Wi-Fi in common areas') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Wi-Fi in common
                                        areas</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Complimentary coffee bar') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Complimentary
                                        coffee bar</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Guest suites') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Guest suites
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'On-site convenience store') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> On-site
                                        convenience store</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Recycling center') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Recycling center
                                    </div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Daily trash pick up') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Daily trash pick
                                        up</div>
                                </div>
                            @endif
                            @if (CMS::check_string($property->amenities, 'Extra storage space') == 'true')
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-clone"></span> Extra storage
                                        space</div>
                                </div>
                            @endif
                    ...
                    <div class="card">
                        <div class="card-body bg-grey">
                            ...
                            <form class="contact-box rt-contact-form" method="POST" action="{!! route('properties.view.inquiry') !!}">
                                ...
                                <input type="hidden" value="{!! $property->product_name !!} Viewing inquiry" name="subject"
                                    required>
                                @csrf
                                <div class="row">
                           ...
                           <input type="time" class="form-control" name="view_time" required/>
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <textarea name="message" class="form-control" cols="30" rows="4"
                                            placeholder="I'm interested in Land/Apartments.."></textarea>
                                    </div>
                                    <div class="form-group col-lg-12">
